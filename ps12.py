...
class SimpleVirus(object):
    ...
    def doesClear(self):
        ...
        """
        # TODO
        #print ("clearProb= ",self.clearProb)
    ...
    def reproduce(self, popDensity):
        ...
        if self.maxBirthProb*(1-popDensity) > random.random():
            #print ("clearProb2= ",self.clearProb)
...
class SimplePatient(object):
    ...
    def update(self):
        ...
        for vr in self.viruses:
            if not vr.doesClear():
                newVirus.append(vr)
                #print ('virus clear', 'remove virus',virus)
                try:
                    child=vr.reproduce(popDensity)
...
def problem2():
    ...
    """
    # TODO    
    #Create 100 Viruses list
    virusesList=[SimpleVirus(0.1,0.05) for i in range(100)]
    patient=SimplePatient(virusesList, 1000)
    res=[]
    for n in range(300): #300times
...
class ResistantVirus(SimpleVirus):
    ...
    def getResistance(self, drug):
        ...
        """
        # TODO
        if self.resistance[drug] == True:
            return True
        elif self.resistance[drug] == False:
            return False
